...
implements StepAdvanceListener
{
	...
	, 
		...
		addReadQuery(Variable.ANGLE,
				new ReadObjectVarQuery.DoubleQ (dis, dos,
						...
						,
						id,
						it.polito.appeal.traci.protocol.Constants.VAR_ANGLE
	...
	public void nextStep(double step) {
		...
		getReadQuery(Variable.ANGLE).setObsolete();
	 ...
	 * @return the instance of {@link ReadObjectVarQuery} relative to this query.
	 */
	public ReadObjectVarQuery<java.lang.Double> queryReadAngle() {
		return (ReadObjectVarQuery.DoubleQ) getReadQuery(Variable.ANGLE);
	}
	 ...
	 * and returns the corresponding value.
	 */
	public java.lang.Double getAngle() throws IOException {
		return ((ReadObjectVarQuery.DoubleQ) getReadQuery(Variable.ANGLE)).get();
	}
